        ...
        <section className='bg-black pb-52'>
            <div className='container mx-auto px-3 md:px-10'>
                <div className='px-5 py-32'>
                    <p className='font-circular-web text-lg text-blue-50 uppercase'>Into the Metagame Layer</p>
                    <p className='max-w-md font-circular-web text-lg text-blue-50 opacity-50'>
                        Immerse yourself in a rich and ever-expanding
                        universe where a vibrant array of products coverage
                ...
                <BentoTilt className='border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]'>
                    <BentoCard
                        ...
                        turning your activities across Web2 and Web3
                         games into a rewarding abventure.'
                    />
                </BentoTilt>
                <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
                    ...
                    <BentoTilt className='bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0'>
                        <BentoCard
                         ...
                         dimension of play to social interaction for
                          Web3 communities.'
                        />
                    </BentoTilt>
                    <BentoTilt className='bento-tilt_1 me-14 md:col-span-1 md:me-0'>
                        <BentoCard
                            ...
                            elevaing your gameplay to be more fun 
                            and productive'
                        />
                    </BentoTilt>
